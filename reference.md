...
<Cards>
  ...
  <Card title="scan (Deprecated)" href="/docs/reference/scan" description="Deprecated. Will be removed in a future major version." />
...
<Cards>
  ...
  <Card title="turbo-ignore (Deprecated)" href="/docs/reference/turbo-ignore" description="Deprecated. Use `turbo query affected` instead." />
