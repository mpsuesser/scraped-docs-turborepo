...
Both package types can be used as targets for [`--filter`](../../reference/run.md#--filter-string) and [`affected`](../../reference/run.md#--affected) calculations.
...
- Environment variables read by your tools still need to be declared in the task's [`env`](../../reference/configuration.md#env) configuration
