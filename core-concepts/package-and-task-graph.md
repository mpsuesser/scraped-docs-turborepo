...
![Task graph visualization. The diagram has one node at the top named "apps/web" with two lines that connect to other nodes, "packages/ui" and "packages/utils" respectively.](https://turborepo.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsimple-task-graph.198vsfavysc04.png&w=3840&q=75&dpl=dpl_3bQdUaRyC74tvRTuv7agd2L81jpc)
