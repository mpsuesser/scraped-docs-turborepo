...
It's best practice that your Application Packages are the "end" of your [Package Graph](package-and-task-graph.md#package-graph), not being installed into other packages of your repository. Your CI/CD pipelines will most often finalize at these nodes of your Package and Task Graphs.
