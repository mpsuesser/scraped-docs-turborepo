...
![12 tasks are being ran in 3 packages, resulting in a ">>> FULL TURBO" cache hit. The total time it takes to restore these tasks from cache is 80 milliseconds.](https://turborepo.dev/_next/image?url=%2F_next%2Fstatic%2Fimmutable%2Fmedia%2Fwhy-turborepo-solution.3jvpui7fq7cfh.png&w=3840&q=75)
...
![A terminal window showing two tasks that have been ran through turbo. They successfully complete in 116 milliseconds.](https://turborepo.dev/_next/image?url=%2F_next%2Fstatic%2Fimmutable%2Fmedia%2Ffull-turbo.3yje78w9s7u_j.png&w=3840&q=75)
...
Outputs containing absolute paths
