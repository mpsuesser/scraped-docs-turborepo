...
![A graphical representation of tasks running sequentially, with lots of empty space where scripts are not being ran.](https://turborepo.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fslow-tasks-light.3buooozk27cm2.png&w=3840&q=75&dpl=dpl_3F46xSPrLipxuWzbbUM4iFdKneg3)

But, to get the same work done **faster** with Turborepo, you can use `turbo run lint build test`:

![A graphical representation of turbo run lint test build. It shows all tasks running in parallel, with much less empty space where scripts are not being ran.](https://turborepo.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fturborepo-tasks-fast-light.0gccg_-he037-.png&w=3840&q=75&dpl=dpl_3F46xSPrLipxuWzbbUM4iFdKneg3)
